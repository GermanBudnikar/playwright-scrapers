...
import { routerGoogle, routerBooking, routerTripadvisor } from './router.js';
...
const crawlerTripadvisor = new PlaywrightCrawler({
    requestHandler: routerTripadvisor,
})
...
await crawlerTripadvisor.run(['https://www.tripadvisor.com.br/Hotel_Review-g303576-d729567-Reviews-Faial_Prime_Suites-Florianopolis_State_of_Santa_Catarina.html'])
await Dataset.exportToCSV('tripadvisor');